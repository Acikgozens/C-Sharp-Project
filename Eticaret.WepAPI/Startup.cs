        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
                {
                    ...
                    Description = "Bearer þemasý kullan. JWT Yetkilendirme baþlýðý\r\n\r\n 'Bearer'[Boþluk] giriniz. Örnek : Bearer 1254545asa5d45a4"
                });
            ...
            /*
            // Service ilk ayaða kalktýðýnda varsayýlan olarak oluþturulan classlar..
